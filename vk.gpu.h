...
namespace vk {
    ...
    struct SwapChain : GPU {
        ...
        SwapChain() {
            ...
            std::thread tColorImage([this] { createImageResource<Color>(color); });
            std::thread tDepthImage([this] { createImageResource<Depth>(depth); });
        ...
        void cleanupSwapChain() {
            ...
            std::jthread tColorImage([this] { destroyImageResource<Color>(color); });
            std::jthread tDepthImage([this] { destroyImageResource<Depth>(depth); });
